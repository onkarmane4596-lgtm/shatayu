            ...
            <div className="container-tight relative z-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 mb-20">
                        ...
                        <Link href="/" className="group inline-flex items-center gap-4 transition-transform duration-300 font-sans">
                            ...
                            <div className="flex flex-col">
                                <span className="text-2xl font-serif font-bold text-white tracking-tight leading-none">
                                    Shatayu <span className="text-[#5DA89F] font-normal">Yoga</span>
                                </span>
                                <span className="text-[10px] uppercase tracking-[0.3em] text-[#5DA89F]/80 mt-1 font-bold">
                                    {SITE_TAGLINE}
                                </span>
                            </div>
                        </Link>
                        ...
                        <div className="flex gap-4">
                            {[
                                ...
                                <a
                                    ...
                                    className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/80 hover:text-[#5DA89F] hover:border-[#5DA89F]/40 hover:bg-[#5DA89F]/10 transition-all duration-300 backdrop-blur-sm"
                                >
                                    <social.icon size={18} />
                                </a>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                <li key={href}>
                                    <Link href={href} className="group text-sm text-white/80 hover:text-[#5DA89F] transition-colors flex items-center gap-2">
                                        <ChevronRight className="w-4 h-4 text-white/30 group-hover:text-[#5DA89F] group-hover:translate-x-1 transition-all duration-300" />
                                        {label}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            {SITE_SERVICES.map((name) => (
                                <li key={name}>
                                    <Link href="/classes" className="group text-sm text-white/80 hover:text-[#5DA89F] transition-colors flex items-center gap-2">
                                        <ChevronRight className="w-4 h-4 text-white/30 group-hover:text-[#5DA89F] group-hover:translate-x-1 transition-all duration-300" />
                                        {name}
                                    </Link>
                                </li>
                    ...
                    <div className="space-y-12">
                        <div>
                            <h4 className="text-white font-serif text-lg font-bold mb-8 relative inline-block">
                                Reach Us
                                <span className="absolute -bottom-2 left-0 w-8 h-[3px] bg-[#5DA89F] rounded-full shadow-[0_0_10px_rgba(93,168,159,0.5)]" />
                            </h4>
                            <ul className="space-y-5">
                                <li className="flex items-center gap-4 group cursor-pointer">
                                    <div className="w-10 h-10 rounded-xl bg-[#5DA89F]/10 flex items-center justify-center text-[#5DA89F] border border-[#5DA89F]/20 transition-all duration-300 group-hover:bg-[#5DA89F] group-hover:text-white group-hover:shadow-[0_0_15px_rgba(93,168,159,0.3)]">
                                        <Phone size={18} />
                                    </div>
                                    <a href={SITE_CONTACT.telLink} className="text-sm font-bold text-white/95 group-hover:text-[#5DA89F] transition-colors">
                                ...
                                <li className="flex items-center gap-4 group cursor-pointer">
                                    ...
                                    <a href={SITE_CONTACT.mailtoLink} className="text-sm font-bold text-white/95 group-hover:text-[#5DA89F] transition-colors break-all">
                                        {SITE_CONTACT.email}
                                    </a>
                                </li>
                                <li className="flex items-start gap-4">
                                    <div className="w-10 h-10 rounded-xl bg-[#5DA89F]/10 flex items-center justify-center text-[#5DA89F] border border-[#5DA89F]/20 mt-0.5 shrink-0">
                                        <MapPin size={18} />
                                    </div>
                        ...
                        <div>
                            <h4 className="text-white font-serif text-sm font-bold uppercase tracking-[0.2em] mb-6 text-[#5DA89F]/80">
                                Practice Hours
                            </h4>
                            <ul className="space-y-3 text-xs font-semibold">
                                ...
                                <li className="flex justify-between items-center text-white/60">
                                    <span>Sat — Sun</span>
                                    <span className="text-[#5DA89F]/90">Morning Only / Closed</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] text-white/50">
                        &copy; {new Date().getFullYear()} Shatayu Yoga • <a href="https://www.techsarthiservices.in/" target="_blank" rel="noopener noreferrer" className="text-[#5DA89F]/80 hover:text-[#5DA89F] hover:underline transition-all">Powered by: Techsarthi</a>
                    </p>

                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-2 text-[10px] font-bold text-white/40 uppercase tracking-widest">
                            <span className="w-1.5 h-1.5 rounded-full bg-[#5DA89F]/60 animate-pulse" />
